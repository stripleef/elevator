...
const TIMELINE = [
  { year: '1960-е', desc: 'Основание Зирганского элеватора — аграрного центра Мелеузовского района Башкортостана.' },
  { year: '1990-е', desc: 'Реорганизация предприятия в ООО «Зирганский Элеватор» и расширение деятельности.' },
  { year: '2010-е', desc: 'Открытие гостиницы «Тирмэн» для приёма гостей, партнёров и путешественников.' },
