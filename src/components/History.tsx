...
const TIMELINE = [
  { year: '1990-е', desc: 'Основание предприятия ООО «Зирганский Элеватор» — аграрного центра Мелеузовского района Башкортостана.' },
  { year: '2016 г.', desc: 'Реорганизация предприятия и расширение производственной инфраструктуры.' },
