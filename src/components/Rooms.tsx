...
const ROOMS: Room[] = [
  ...
  },
  {
    ...
    desc: 'Комфортный номер с одной двуспальной и одной односпальной кроватью, телевизором и кондиционером. Общий душ и туалет расположены на этаже.',
    amenities: [
      { icon: Users, label: '1 двуспальная + 1 односпальная кровать' },
      { icon: ShowerHead, label: 'Душ и туалет на этаже' },
      { icon: Tv, label: 'ТВ' },
      { icon: Wind, label: 'Кондиционер' },
      { icon: Wifi, label: 'Wi-Fi' },
